...
2. **Build the Skill**.
    ...
    ```
    docker build --build-arg base_img=c12e/spark-template:profile-jar-base-6.3.2-rc.1 -t profiles-example:latest -f ./main-app/build/resources/main/Dockerfile ./main-app/build
    [+] Building 1.5s (17/17) FINISHED
    => [internal] load build definition from Dockerfile                                                                                                                                                                                     0.0s
    => => transferring dockerfile: 37B                                                                                                                                                                                                      0.0s
    => [internal] load .dockerignore                                                                                                                                                                                                        0.0s
    => => transferring context: 2B                                                                                                                                                                                                          0.0s
    => [internal] load metadata for docker.io/c12e/spark-template:profile-jar-base-6.3.2-rc.1                                                                                                                                              1.0s
    ...
    => [stage-0 1/9] FROM docker.io/c12e/spark-template:profile-jar-base-6.3.2-rc.1@sha256:331f93e1290442934adbd14e904740ef458d2ea012c3288d689608e9202899dd                                                                                0.0s
