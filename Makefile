...
create-app-image:
	docker build --build-arg base_img=c12e/spark-template:profile-jar-base-6.3.2-rc.1 -t ${DOCKER_IMAGE}:${TAG} -f ./main-app/build/resources/main/Dockerfile ./main-app/build
